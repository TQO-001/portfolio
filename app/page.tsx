...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] font-mono selection:bg-orange-500/30 overflow-x-hidden">
      {/* Grid background */}
        ...
        <section id="about" className="grid grid-cols-1 lg:grid-cols-4 gap-4">
          ...
          <div className="space-y-4">
            <div className="p-8 bg-zinc-900/20 border border-zinc-800 border-l-2 border-l-orange-500">
              <span className="text-[12px] text-zinc-200 font-bold uppercase block mb-2 underline">
                System_Status
              </span>
              <p className="text-white font-bold tracking-tighter text-lg">
                CompTIA Network+
              </p>
              <p className="text-orange-500 text-[12px] mt-1 font-bold">
                IN_PROGRESS_2026
              </p>
            </div>
            ...
            <div className="p-8 bg-zinc-900/20 border border-zinc-800">
              ...
              <p className="text-zinc-300 text-[12px] mt-1 font-bold">
                REACT / NODE / .NET
              </p>
            </div>
          </div>
            ...
            {projects.map((project) => (
              ...
              >
                <div className="flex justify-between items-start mb-3">
                  <h3 className="text-white font-bold group-hover:text-orange-500">
                    {project.title}
                  </h3>
                  <ExternalLink size={14} className="text-zinc-700 group-hover:text-orange-500" />
                </div>
        ...
        <section id="contact" className="pt-8 border-t border-zinc-900">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            {["AZ-900", "MS-900", "MD-100"].map((cert) => (
              <div
                key={cert}
                className="p-4 bg-zinc-900/30 border border-zinc-800 text-[12px] text-zinc-300 font-bold tracking-tighter hover:text-white transition-colors"
              >
                {cert} CERTIFIED
              </div>
            ))}
