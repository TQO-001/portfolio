            ...
            {navItems.map((item) => {
              ...
              return (
                <a
                  key={item.label}
                  href={item.href}
                  className={`group relative flex items-center gap-1 text-[10px] font-bold tracking-widest uppercase transition-colors
                ...
                >
                  ...
                  {/* Underline */}
                  <span
                    className={`absolute -bottom-1 left-0 h-[1px] bg-blue-500 transition-all
                  ...
                  {/* Glow for active tab */}
                  {isActive && (
                    <span className="absolute inset-x-0 -bottom-2 h-[2px] bg-blue-500/40 blur-sm" />
                  )}
                </a>
              );
            })}
